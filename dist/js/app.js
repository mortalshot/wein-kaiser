(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".promotions_template1 .promotions__slider")) new core(".promotions_template1 .promotions__slider", {
            modules: [ Navigation, Lazy ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".promotions_template2 .promotions__slider")) new core(".promotions_template2 .promotions__slider", {
            modules: [ Navigation, Lazy ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".promotions_template3 .promotions__slider")) new core(".promotions_template3 .promotions__slider", {
            modules: [ Navigation, Lazy ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.2,
    ...
    if (firstscreen) {
        ...
        if (firstscreen == parent.firstElementChild) {
            ...
            window.addEventListener("scroll", (function() {
                ...
                if (scrollTop > 0) wrapper.classList.remove("_header-bg"); else wrapper.classList.add("_header-bg");
            }));
        }
    }
    window["FLS"] = true;
